...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normbgcolor, "-sb", normfgcolor, "-sf", normfgcolor, NULL };
static const char *termcmd[]  = { "ghostty", NULL };
static const char *launchercmd[] = { "rofi", "-show", "drun", NULL };
static const char *lgcmd[] = { "looking-glass-client", "-F", "-m", "key_insert", NULL };
static const char *browser[] = {"app.zen_browser.zen", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_w,      spawn,          {.v = lgcmd }  },
	{ MODKEY|ShiftMask,             XK_s,      spawn,           SHCMD("shutdown -h now")},
	{ MODKEY,                       XK_m,      setlayout,       SHCMD("reboot") },
